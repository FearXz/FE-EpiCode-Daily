...
// "17:00 - DEBRIEF"
// "20:00 - CENA FS0623B"
// il 9 novembre è un array di stringhe --> ["14:30 - Q&A", "17:00 - DEBRIEF", "20:00 - CENA FS0423"]
...
const printCurrentMonthInH1 = function () {
  ...
  const monthIndex = now.getMonth() // 10 perchè siamo in novembre
...
const daysInThisMonth = function () {
  ...
  const lastDayInTheMonth = new Date(getYear, getMonth + 1, 0) // -> 0 dicembre 2023 === 30 novembre 2023
...
const createDays = function (numberOfDays) {
  // numerOfDays adesso è 30 (in novembre)
