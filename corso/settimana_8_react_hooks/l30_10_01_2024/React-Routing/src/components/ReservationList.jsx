    ...
    <Container>
      <Row className="justify-content-center">
        <Col xs={12} md={6}>
          ...
          {hasError && <Alert variant="danger">Errore nel caricamento dati</Alert>}
          {isLoading && <Spinner animation="border" variant="primary" className="ms-2" />}
          ...
          <ListGroup>
            ...
            {reservations.length === 0 && !hasError && isLoading && <Alert variant="info">Caricamento...</Alert>}
            {reservations.length === 0 && !hasError && !isLoading && <ListGroup.Item>Non ci sono prenotazioni al momento</ListGroup.Item>}
          </ListGroup>
        </Col>
      </Row>
    </Container>
