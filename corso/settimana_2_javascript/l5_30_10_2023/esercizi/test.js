...
document.querySelector(".es2").innerHTML = 'il mio nome è: '+ myName;
...
document.querySelector(".es3").innerHTML = 'il risultato di 12+20 è: '+ ris1;
...
var x=12;
document.querySelector(".es4").innerHTML = x;
...
/* SCRIVI QUI LA TUA RISPOSTA */
console.log("x=12 \n4-x = "+ (4-x));
document.querySelector(".es6").innerHTML = "x=12 \n4-x = "+ (4-x);
...
document.querySelector(".es71").innerHTML = (name1 == name2) ? 'Sono uguali': 'Sono diversi' ;
document.querySelector(".es72").innerHTML = (name1 == name2.toLowerCase()) ? 'Sono uguali': 'Sono diversi' ;
